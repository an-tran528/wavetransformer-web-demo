(function($) {
	...
	$('audio[controls]').before(function(){
		...
		var player_box = document.createElement('div');
			$(player_box).addClass('container-fluid playa row');
		...
		var addSeek = function() {
			...
			var seek_wrapper = document.createElement('div');
				$(seek_wrapper).addClass('btn btn-link disabled col-md-4 col-sm-5 hidden-xs');
		...
		var addTime = function() {
			var time = document.createElement('a');
				$(time).addClass('btn col-md-3 hidden-sm hidden-xs');
		...
		var addMute = function() {
			var mute = document.createElement('button');
				$(mute).addClass('btn col-xs-1 col-sm-1 col-sm-offset-9 col-xs-offset-9');
		...
		var addVolume = function() {
			...
			var vol_wrapper = document.createElement('div');
				$(vol_wrapper).addClass('btn disabled col-sm-4 col-md-3 hidden-xs');
